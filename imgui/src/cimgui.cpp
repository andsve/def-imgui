...
{
    return IM_NEW(ImVector_ImGuiTextRange)();
}
...
{
    return IM_NEW(ImVector_ImGuiStoragePair)();
}
...
{
    return IM_NEW(ImVector_ImFontAtlasCustomRect)();
}
...
{
    return IM_NEW(ImVector_ImGuiTextRange)(src);
}
...
{
    return IM_NEW(ImVector_ImGuiStoragePair)(src);
}
...
{
    return IM_NEW(ImVector_ImU32)(src);
}
...
{
    return IM_NEW(ImVector_ImFontAtlasCustomRect)(src);
}
